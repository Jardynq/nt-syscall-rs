...
pub macro callconv_syscall {
    ...
    (@arg 0) => { "" },
    (@arg 1) => {
        x64::assemble!("mov r10, qword [rcx]")
    },
    (@arg 2) => {
        concat!(
            x64::assemble!("mov rdx, qword [rcx + 0x8]"),
            x64::callconv_syscall!(@arg 1)
        )
    },
    (@arg 3) => {
        concat!(
            x64::assemble!("mov r8, qword [rcx + 0x10]"),
            x64::callconv_syscall!(@arg 2)
        )
    },
    (@arg 4) => {
        concat!(
            x64::assemble!("mov r9, qword [rcx + 0x18]"),
            x64::callconv_syscall!(@arg 3)
        )
    },
    (@arg 5) => {
        concat!(
            x64::assemble!("mov rax, qword [rcx + 0x20]"),
            x64::assemble!("mov qword [rsp + 0x28], rax"),
            x64::callconv_syscall!(@arg 4),
        )
    },
    (@arg 6) => {
        concat!(
            x64::assemble!("mov rax, qword [rcx + 0x28]"),
            x64::assemble!("mov qword [rsp + 0x30], rax"),
            x64::callconv_syscall!(@arg 5),
        )
    },
    (@arg 7) => {
        concat!(
            x64::assemble!("mov rax, qword [rcx + 0x30]"),
            x64::assemble!("mov qword [rsp + 0x38], rax"),
            x64::callconv_syscall!(@arg 6),
        )
    },
    (@arg 8) => {
        concat!(
            x64::assemble!("mov rax, qword [rcx + 0x38]"),
            x64::assemble!("mov qword [rsp + 0x40], rax"),
            x64::callconv_syscall!(@arg 7),
        )
    },
    (@arg 9) => {
        concat!(
            x64::assemble!("mov rax, qword [rcx + 0x40]"),
            x64::assemble!("mov qword [rsp + 0x48], rax"),
            x64::callconv_syscall!(@arg 8),
        )
    },
    (@arg 10) => {
        concat!(
            x64::assemble!("mov rax, qword [rcx + 0x48]"),
            x64::assemble!("mov qword [rsp + 0x50], rax"),
            x64::callconv_syscall!(@arg 9),
        )
    },
    (@arg 11) => {
        concat!(
            x64::assemble!("mov rax, qword [rcx + 0x50]"),
            x64::assemble!("mov qword [rsp + 0x58], rax"),
            x64::callconv_syscall!(@arg 10),
        )
    },
    (@arg 12) => {
        concat!(
            x64::assemble!("mov rax, qword [rcx + 0x58]"),
            x64::assemble!("mov qword [rsp + 0x60], rax"),
            x64::callconv_syscall!(@arg 11),
        )
    },
    (@arg 13) => {
        concat!(
            x64::assemble!("mov rax, qword [rcx + 0x60]"),
            x64::assemble!("mov qword [rsp + 0x68], rax"),
...
pub macro callconv_win64 {
    ...
    (@ret float) => {
        concat!(
            x64::assemble!("mov rdx, qword [rcx]"),
            x64::assemble!("movsd qword [rdx], xmm0")
        )
    },
    ...
    (@arg 1) => {
        concat!(
            x64::assemble!("movsd xmm0, qword [rcx]"),
            x64::assemble!("mov rcx, qword [rcx]")
        )
    },
    (@arg 2) => {
        concat!(
            x64::assemble!("movsd xmm1, qword [rcx + 0x8]"),
            x64::assemble!("mov rdx, qword [rcx + 0x8]"),
    ...
    (@arg 3) => {
        concat!(
            x64::assemble!("movsd xmm2, qword [rcx + 0x10]"),
            x64::assemble!("mov r8, qword [rcx + 0x10]"),
    ...
    (@arg 4) => {
        concat!(
            x64::assemble!("movsd xmm3, qword [rcx + 0x18]"),
            x64::assemble!("mov r9, qword [rcx + 0x18]"),
    ...
    (@arg 5) => {
        concat!(
            x64::assemble!("mov rax, qword [rcx + 0x20]"),
            x64::assemble!("mov qword [rsp + 0x20], rax"),
