...
pub macro callconv_win64 {
    (@arg ($($count:tt)+), i8 $(, $($tail:tt)* )?) => { x64::callconv_win64!(@arg ($($count)+), u8 $(, $($tail)* )?) },
    (@arg (0), u8  $(, $($tail:tt)* )?) => {
        concat!(
    ...
    (@arg ($($count:tt)+), i16 $(, $($tail:tt)* )?) => { x64::callconv_win64!(@arg ($($count)+), u16 $(, $($tail)* )?) },
    (@arg (0), u16  $(, $($tail:tt)* )?) => {
        concat!(
            x64::callconv_win64!(@arg (1) $(, $($tail)* )?),
    ...
    (@arg ($($count:tt)+), i32 $(, $($tail:tt)* )?) => { x64::callconv_win64!(@arg ($($count)+), u32 $(, $($tail)* )?) },
    (@arg (0), u32  $(, $($tail:tt)* )?) => {
        concat!(
            x64::callconv_win64!(@arg (1) $(, $($tail)* )?),
    ...
    (@arg ($($count:tt)+), i64 $(, $($tail:tt)* )?) => { x64::callconv_win64!(@arg ($($count)+), u64 $(, $($tail)* )?) },
    (@arg (0), u64  $(, $($tail:tt)* )?) => {
        concat!(
            x64::callconv_win64!(@arg (1) $(, $($tail)* )?),
    ...
    (@ret ()) => { "" },
    (@ret i8) => { x64::callconv_win64!(@ret u8) },
    (@ret u8) => {
        concat!(
    ...
    (@ret i16) => { x64::callconv_win64!(@ret u16) },
    (@ret u16) => {
        concat!(
            x64::assemble!("mov rdx, qword ptr [rcx]"),
    ...
    (@ret i32) => { x64::callconv_win64!(@ret u32) },
    (@ret u32) => {
        concat!(
            x64::assemble!("mov rdx, qword ptr [rcx]"),
    ...
    (@ret i64) => { x64::callconv_win64!(@ret u64) },
    (@ret u64) => {
        concat!(
            x64::assemble!("mov rdx, qword ptr [rcx]"),
